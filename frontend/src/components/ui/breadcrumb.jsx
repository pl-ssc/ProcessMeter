...
const Breadcrumb = React.forwardRef(({ className, ...props }, ref) => <nav ref={ref} aria-label="breadcrumb" className={cn(className)} {...props} />);
...
const BreadcrumbPage = React.forwardRef(({ className, ...props }, ref) => (
  <span ref={ref} aria-current="page" aria-disabled="true" className={cn('font-medium text-foreground', className)} {...props} />
));
